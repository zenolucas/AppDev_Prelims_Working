...
namespace My9487Team2Resources {
	...
	/// <summary>
	/// Summary for AdminLoginGui
	/// </summary>
	public ref class AdminLoginGui : public System::Windows::Forms::Form
	{
	public:
		AdminLoginGui(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(AdminLoginGui::typeid));
			...
			this->btnLogin->Click += gcnew System::EventHandler(this, &AdminLoginGui::btnLogin_Click);
			// 
			// txtPassword
			// 
